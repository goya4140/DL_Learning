"""
实验日志工具（与 MLP/CNN/RNN/LSTM/GCN 保持一致）
...
class ExperimentLogger:
    def __init__(self, log_dir: str = "./logs", lr_step_size: int = 3):
    ...
    def plot(self):
        ...
        title = "Transformer 训练曲线（AG News）" if _HAS_CJK else "Transformer Training Curves (AG News)"
        ...
        ax2.annotate(f"Best: {best_val_acc:.2f}%",
                     ...
                     xytext=(best_epoch + 0.3, best_val_acc - 0.5),
